...
class generator(nn.Module):
    def __init__(self):
        ...
        self.gen=nn.Sequential(
            ...
            nn.Tanh()  # Tanh激活使得生成数据而分布咋[-1,1]之间
        )
...
for epoch in range(num_epoch):  #进行多个epoch的训练
    for i,(img,_) in enumerate(dataloader):
        ...
        real_scores=real_out # 得到真是图片的判别值，输入的值越是接近1越好
        ...
        fake_scores = fake_out  # 得到假图片的判别值，对于判别器来说，假图片的损失越接近0越
        ...
        fake_img_=G(z)  #随机噪声输入到生成器中，得到一副假的图片
